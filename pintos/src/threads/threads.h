...
/*Funcao usada quando houver necessidade de doar prioridade. Setta a prioridade da thread atual para new_priority. Caso a thread para qual a 
prioridade será doada for a que está executando, entao chama faz-se uma chamada para thread_set_priority pois pode ser que seja necessario
efetuar uma thread_yield*/
